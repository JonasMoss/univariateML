...
expect_equal(ppmlplot(y, obj, plot.it = FALSE),
             ppmlplot(y, obj, plot.it = FALSE, datax = FALSE))

# Do x and y switch places when 'datax = TRUE'
expect_equal(ppmlplot(y, obj, plot.it = FALSE, datax = FALSE)$y,
             ppmlplot(y, obj, plot.it = FALSE, datax = TRUE)$x)

expect_equal(ppmlplot(y, obj, plot.it = FALSE, datax = FALSE)$x,
...
expect_equal(ppmlplot(y, obj, plot.it = FALSE),
             ppmlplot(y, obj))
expect_equal(ppmlpoints(y, obj, plot.it = FALSE),
             ppmlpoints(y, obj))
...
# Is datax the default value?
expect_equal(qqmlplot(y, obj, plot.it = FALSE),
             qqmlplot(y, obj, plot.it = FALSE, datax = FALSE))

# Do x and y switch places when 'datax = TRUE'
expect_equal(qqmlplot(y, obj, plot.it = FALSE, datax = FALSE)$y,
             qqmlplot(y, obj, plot.it = FALSE, datax = TRUE)$x)

expect_equal(qqmlplot(y, obj, plot.it = FALSE, datax = FALSE)$x,
...
expect_equal(qqmlplot(y, obj, plot.it = FALSE),
             qqmlplot(y, obj))
expect_equal(qqmlpoints(y, obj, plot.it = FALSE),
             qqmlpoints(y, obj))
