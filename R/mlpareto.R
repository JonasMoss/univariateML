...
#'     `1/(mean(log(x)) - log(b))`.
#'
#' For the density function of the Pareto distribution see [Pareto][extraDistr::Pareto].
#'
#' @param x a (non-empty) numeric vector of data values.
#' @param na.rm logical. Should missing values be removed?
#' @return `mlpareto` returns an object of [class][base::class] `univariateML`. This
