...
#'
#' For the density function of the log-logistic distribution see [Loglogistic][actuar::Loglogistic]
#'
#' @param x a (non-empty) numeric vector of data values.
#' @param na.rm logical. Should missing values be removed?
#' @return `mlllogis` returns an object of [class][base::class] `univariateML`. This
