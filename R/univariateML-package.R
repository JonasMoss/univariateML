...
#' selection of parametric univariate densities.
#'
#' Data analysis often requires the estimation of univariate densities. Maximum likelihood estimation
...
#' \itemize{
#'   \item Support maximum likelihood estimation of a large selection of densities.
#'   \item Supports plenty of generics such as \code{plot} and \code{AIC} to aid your data analysis.
#' }
#'
