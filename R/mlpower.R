...
#'
#' For the density function of the power distribution see [PowerDist][extraDistr::PowerDist].
...
#' @param epsilon Positive number added to `max(x)` as an approximation
#'    to the maximum likelihood.
#' @return `mlpower` returns an object of [class][base::class] `univariateML`. This
...
#' @examples
#' mlpower(precip)
#' @seealso [PowerDist][extraDistr::PowerDist] for the power density. [Pareto] for
