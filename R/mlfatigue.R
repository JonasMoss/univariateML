...
#' @examples
#' mlfatigue(precip)
#' @references From, S. G., & Li, L. (2006). Estimation of the parameters of the Birnbaum–Saunders distribution. Communications in Statistics: Theory and Methods, 35(12), 2157–2169. https://doi.org/10.1080/03610920600853563
#' @export
