newton_secant <- function(f_df, x0) {
...
# plot(y, sapply(y, function(y) -f_df(y)[1]), type = "l")
plot(y, sapply(y, function(y) f_df(y)[1] / sqrt(f_df(y)[2])), type = "l", col = "red")
abline(h = 0, col = "grey")
abline(v = x0)
